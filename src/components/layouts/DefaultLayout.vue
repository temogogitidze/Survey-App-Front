    ...
    <Disclosure as="nav" class="bg-gray-800" v-slot="{ open }">
              ...
              <Menu as="div" class="relative ml-3">
                <div>
                  ...
                  >
                    ...
                    <p class="text-white mr-3">{{ user.data.name }}</p>
                    <img
                ...
                >
                  ...
                  >
                    <MenuItem v-slot="{ active }">
                      <a
                        @click="logout()"
                        class="cursor-pointer block px-4 py-2 text-sm text-gray-700 hover:text-violet-700"
                        >Sign out</a
                      >
                    </MenuItem>
                  </MenuItems>
      ...
      <DisclosurePanel class="md:hidden">
        ...
        <div class="border-t border-gray-700 pt-4 pb-3">
          ...
          <div class="pointer mt-3 space-y-1 px-2">
            <DisclosureButton
              @click="logout()"
